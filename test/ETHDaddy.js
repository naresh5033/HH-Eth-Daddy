...
describe("ETHDaddy", () => {
  ...
  beforeEach(async () => {
    // Setup accounts       //the getsigners() is an abj that contains the wallet of the users
    [deployer, owner1] = await ethers.getSigners();//the 1 st 2 acc of the 20 hh acc
   /* const signers = await ethers.getSigners();
    console.log(signers) --> will gives the 20 signers/acc of the hh */
